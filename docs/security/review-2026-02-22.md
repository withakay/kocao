...
- Attach websocket under `/api/v1/workspace-sessions/{id}/attach`
...
- Reconciles Workspace Session (`Session`) and `HarnessRun` CRDs
...
- Fix direction: audit attach connect/disconnect, role/lease changes, and backend exec Harness Run Lifecycle.
